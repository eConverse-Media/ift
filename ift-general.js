...
function handleMobileNav() {
    ...
    $('.mobile-nav').removeAttr('id');
    $('.mobile-nav #MPButtonBar').addClass('button-bar').removeAttr('id');
    $('.mobile-nav .search-bar-top').remove();
    $('.mobile-nav .search-btn-top').remove();
    $('#NAV #searchColumn').remove();
